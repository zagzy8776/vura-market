...
export default function AdminApp() {
  ...
  if (loading) {
    return <div className="grid min-h-screen place-items-center bg-[#080a12] text-white"><div className="flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-xl bg-vura-500"><Zap size={19} fill="currentColor" /></span><span className="text-xl font-black">Vura Studio</span></div></div>;
  }
